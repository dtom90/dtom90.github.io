  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col">
          <h1 className="text-text-primary font-semibold m-0 text-heading-1">
            <a href="/" className="transition-colors no-underline link-no-underline">David Thomason</a>
          </h1>
        ...
        <ul className="flex flex-col list-none p-0 m-0 mt-18">
          <li>
            <div className="flex items-center gap-3">
              ...
              <a href="#about" className={`no-underline transition-colors block text-nav my-3 hover:text-text-link ${activeSection === 'about' ? 'text-text-primary' : 'text-text-secondary'}`}>
                About
              </a>
            </div>
          </li>
      ...
      <div className="flex items-center gap-4 mt-6">
        <a 
          href="/DavidThomasonRésumé-2026-01-06.pdf" 
          target="_blank" 
